    ...
    <head>
        ...
        <style>
            html, body {
                ...
                height: 100vh;
                margin: 0;
                {{--background-image: url("{{ asset ('assets/images/main/xsocial.jpg') }}") ;--}}
            ...
            <div class="content">
                <div id="myCarousel" class="carousel slide" data-ride="carousel"> <!-- slider -->
                    ...
                    <div class="carousel-inner" role="listbox">
                        @foreach(glob("assets/images/main/*.jpg") as $image)
                            @if($loop->first)
                            <div class="carousel-item active" data-index="{{ $loop->index }}">
                                <img class="fill" src="{{$image}}">
                            </div>
                            @endif
